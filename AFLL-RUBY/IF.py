...
tokens = ('IF', 'ELSE', 'IDENTIFIER', 'NUMBER', 'EQUALS', 'LPAREN', 'RPAREN','PUTS','STRING','END','PLUS','EQUALS_TO')
...
def p_statement_if(p):
    ...
    print("If statement:", p[2])

def p_statement_if_else(p):
    'statement : IF expression statements ELSE statements END'
    print("If-else statement:", p[2])
...
"if x==2 puts 'okay' else puts 'fine' end"